...
class sftpUtil{
   ...
   */
  isDir(target){
    return  _checkStatWrapper.bind(this, this.sftp.lstat.bind(this.sftp), 'dir')(target);
  }
  /**
   ...
   */
  isFile(target){
    return  _checkStatWrapper.bind(this, this.sftp.lstat.bind(this.sftp), 'file')(target);
  }
