...
class ARsshClient extends EventEmitter {
  ...
  async exec(cmd, opt = {}, stdout = null, stderr = null) {
    ...
    return this._batch.qsubAndWait({
      exec: () => {
        this._prologue();
        return execJob(this._cm, cmd, opt, stdout, stderr);
      },
      name: "exec"
    });
  }
  ...
  async send(src, dst, only, exclude, opt = {}) {
    ...
    return this._batch.qsubAndWait({
      exec: () => {
        this._prologue();
        return sftpJob(this._cm, func, src, dst, only, exclude, opt);
      },
      name: "send"
    });
  }
  ...
  async recv(src, dst, only, exclude, opt = {}) {
    ...
    return this._batch.qsubAndWait({
      exec: () => {
        this._prologue();
        return sftpJob(this._cm, SftpUtil.get, src, dst, only, exclude, opt);
      },
      name: "recv"
    });
  }
  ...
  async mkdir_p(target) {
    ...
    return this._batch.qsubAndWait({
      exec: () => {
        this._prologue();
        return sftpJob(this._cm, SftpUtil.mkdir_p, target);
      },
      name: "mkdir_p"
    });
  }
  ...
  async rm_rf(target) {
    ...
    return this._batch.qsubAndWait({
      exec: () => {
        this._prologue();
        return sftpJob(this._cm, SftpUtil.rm_rf, target);
      },
      name: "rm_rf"
    });
  }
  ...
  async realpath(target) {
    ...
    return this._batch.qsubAndWait({
      exec: () => {
        this._prologue();
        return sftpJob(this._cm, SftpUtil.realpath, target);
      },
      name: "realpath"
    });
  }
  ...
  async ls(target) {
    ...
    return this._batch.qsubAndWait({
      exec: () => {
        this._prologue();
        return sftpJob(this._cm, SftpUtil.ls, target);
      },
      name: "ls"
    });
  }
  ...
  async chmod(target, mode) {
    ...
    return this._batch.qsubAndWait({
      exec: () => {
        this._prologue();
        return sftpJob(this._cm, SftpUtil.chmod, target, mode);
      },
      name: "chmod"
    });
  }
  ...
  async chown(target, uid, gid) {
    ...
    return this._batch.qsubAndWait({
      exec: () => {
        this._prologue();
        return sftpJob(this._cm, SftpUtil.chown, target, uid, gid);
      },
      name: "chown"
    });
  }
